...
export const getQuestionAnserIndex = createSelector([getGameState], (state) => state.questionAnserIndex);
export const getCurrentPairs = createSelector(
    [getChosenPackName, getChosenGeneralTopic, getQuestionAnserIndex],
    (packname, generalTopic) => packname && generalTopic && topics[generalTopic].packs[packname].pairs
);
